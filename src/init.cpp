...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables KadiCoin bootstrap mode. Allows KDC client to connect to Bitcoin p2p network to download blockahin history."));
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    fKDCBootstrapping = gArgs.GetBoolArg("-bootstrap", false);
