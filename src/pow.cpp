...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    bool postfork = nHeight >= params.KDCHeight;
    ...
    else if (nHeight < params.KDCHeight + params.KDCPremineWindow) {
        return nProofOfWorkLimit;
    }
    else if (nHeight < params.KDCHeight + params.KDCPremineWindow + params.nPowAveragingWindow){
