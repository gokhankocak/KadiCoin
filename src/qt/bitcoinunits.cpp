...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case KDC: return QString("Bitcoins");
    case mKDC: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uKDC: return QString("Micro-Bitcoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
